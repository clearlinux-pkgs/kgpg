...
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/kgpg-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/kgpg-25.04.0.tar.xz.sig
...
%setup -q -n kgpg-25.04.0
cd %{_builddir}/kgpg-25.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744951337
mkdir -p clr-build
pushd clr-build
