...
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/kgpg-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/kgpg-24.12.2.tar.xz.sig
...
%setup -q -n kgpg-24.12.2
cd %{_builddir}/kgpg-24.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738995665
mkdir -p clr-build
pushd clr-build
